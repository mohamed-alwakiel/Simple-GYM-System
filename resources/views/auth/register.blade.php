            ...
            <div class="card card-info ">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        ...
                        <input name="dob" type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask placeholder="Date of Birth">
                    </div>

                    <!-- Gender -->
                    <div class="input-group my-4">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="customRadio1" name="gender" checked>
