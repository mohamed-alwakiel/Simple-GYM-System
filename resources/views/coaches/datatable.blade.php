        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <center> <a href='{{route('coaches.create')}}' style="margin-top: 10px;" class="btn btn-success">Add New Coache</a></center>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Are you sure you want to delete this Coache</h3>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click','#delete_item',function () {
            var coacheId = $(this).attr('row_delete');
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                url: '/coaches/'+coacheId,
                type: 'DELETE',
                success: function () {
