                ...
                <table id="table" class="table text-center table-hover">
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('cityManagers.show',  $manager->id) }}" class="btn btn-md btn-info mr-2" title="show"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('cityManagers.edit', $manager->id) }}" class="btn btn-md btn-warning mr-2" title="Edit"><i class="fas fa-edit"></i></a>
