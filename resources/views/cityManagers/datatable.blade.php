        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <center> <a href='{{route('cityManagers.create')}}' style="margin-top: 10px;" class="btn btn-success">Create City Manager</a></center>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click','#delete_item',function () {
            var cityManagerId = $(this).attr('row_delete');
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                url: '/cityManagers/'+cityManagerId,
                type: 'DELETE',
                success: function () {
