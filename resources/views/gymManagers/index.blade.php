                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                ...
                                <a href="{{ route('gymManagers.ban', $manager->id) }}" class="btn btn-md btn-dark px-3 mr-2" title="Ban"><i class="fas fa-user"></i></a>
                                @endif
                                <a href="{{ route('gymManagers.show',  $manager->id) }}" class="btn btn-md btn-info mr-2" title="show"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('gymManagers.edit', $manager->id) }}" class="btn btn-md btn-warning mr-2" title="Edit"><i class="fas fa-edit"></i></a>
